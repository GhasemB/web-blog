...
import Commnets from '../comment/Commnets';
...
const BlogPage = () => {
  ...
  const {data, loading, errors} = useQuery(GET_POST_INFO, { variables: {slug},})
      ...
      <Grid container>
        ...
        <Grid item xs={12} mt={7} display='flex' alignItems='center'>
          ...
          <Box component='div'>
            ...
            <Typography component='p' variant='p' color='text.secondary' >{data.post.author.name}</Typography>
          </Box>
        </Grid>
        <Grid item xs={12} mat={5}>
